...
sensorConfig = ConfigParser.RawConfigParser()
...
while True:
	...
	if (curTime-lastUpdated)>delayTime:
		...
		for i in sensorPlugins:
			...
			dataDict["quantity"] = i.valName
			dataDict["ontology"] = i.ontology
			dataDict["uom_name"] = i.valUnit
			dataDict["uom_symbol"] = i.valUnitSymbol
			dataDict["uom_ontology"] = i.uom_ontology
			dataDict["sensor_longName"] = i.sensor_longName
			dataDict["sensor_shortName"] = i.sensor_shortName
			dataDict["sensor_manufacturerURL"] = i.sensor_manufacturerURL
			dataDict["sensor_manufacturer"] = i.sensor_manufacturer
			dataDict["sensor_URN"] = i.sensor_URN
